...
Elm.Image = Elm.Image || {};
Elm.Image.make = function (_elm) {
   "use strict";
   _elm.Image = _elm.Image || {};
   if (_elm.Image.values) return _elm.Image.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var view = function (model) {    return A2($Html.img,_U.list([$Html$Attributes.src(model.src)]),_U.list([]));};
   var defaultSize = 400;
   var initDefault = {width: defaultSize
                     ,height: defaultSize
                     ,src: A2($Basics._op["++"],
                     "http://placehold.it/",
                     A2($Basics._op["++"],$Basics.toString(defaultSize),A2($Basics._op["++"],"x",$Basics.toString(defaultSize))))};
   var Model = F3(function (a,b,c) {    return {width: a,height: b,src: c};});
   var initWithSrc = function (imgUrl) {    return A3(Model,defaultSize,defaultSize,imgUrl);};
   return _elm.Image.values = {_op: _op,Model: Model,defaultSize: defaultSize,initDefault: initDefault,initWithSrc: initWithSrc,view: view};
};
Elm.Candidate = Elm.Candidate || {};
Elm.Candidate.make = function (_elm) {
   "use strict";
   _elm.Candidate = _elm.Candidate || {};
   if (_elm.Candidate.values) return _elm.Candidate.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var initDefault = {id: "9cyvbwecx7z6"
                     ...
                     ,votes: 50};
   var init = F6(function (id,number,name,intro,imgUrl,votes) {
...
Elm.App.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Candidate = Elm.Candidate.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var candidatesJsonDecoder = A2($Json$Decode._op[":="],
   "data",
   $Json$Decode.list(A7($Json$Decode.object6,
   $Candidate.init,
   A2($Json$Decode._op[":="],"id",$Json$Decode.string),
   A2($Json$Decode.map,
   function (x) {
      return A2($Result.withDefault,0,$String.toInt(x));
   },
   A2($Json$Decode.at,_U.list(["images","downsized","height"]),$Json$Decode.string)),
   A2($Json$Decode._op[":="],"type",$Json$Decode.string),
   A2($Json$Decode._op[":="],"url",$Json$Decode.string),
   A2($Json$Decode.at,_U.list(["images","downsized","url"]),$Json$Decode.string),
   A2($Json$Decode.map,
   function (x) {
      return A2($Result.withDefault,0,$String.toInt(x));
   },
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("grid")]),A2($List.map,$Candidate.view,model))
              ...
              _U.list([A2($Html.button,
                      _U.list([$Html$Attributes.$class("action action--close")]),
                      _U.list([A2($Html.i,_U.list([$Html$Attributes.$class("fa fa-times")]),_U.list([]))
                              ,A2($Html.span,_U.list([$Html$Attributes.$class("text-hidden")]),_U.list([$Html.text("Close")]))]))
                      ,A2($Html.div,_U.list([$Html$Attributes.$class("description description--preview")]),_U.list([]))]))]))]));
   });
   var RequestCandidates = {ctor: "RequestCandidates"};
   ...
   var init = {ctor: "_Tuple2",_0: _U.list([]),_1: getCandidates};
